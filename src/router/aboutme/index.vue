<template>
  <div class="info">
    <div v-if="pageIndexed === 2">
      <div class="info__head">
        <h2 class="info__head__title" :class="titleState">about</h2>
      </div>
      <div class="info__ck1">
        <div class="info__ck1__back" :class="ck1State">
          <img src="./../../assets/img/4c6a87339527110ead0ce5c46073be42.png" alt="">
        </div>
        <div class="info__ck1__text" :class="ck1State ? 'text__fade' : ''">
          <p>about</p>
          <p>about</p>
